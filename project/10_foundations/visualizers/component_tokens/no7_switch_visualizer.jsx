...
const SWITCH_TOKEN_DESC = {
  ...
  TRACK_COLOR_ON:   '選中態 track 色：統一走主題色 primary.main',
};
...
function FoundationsCTSwitchSection() {
  return (
    <DCSection
      ...
      subtitle="RN 原生 Switch 兩態色彩政策。thumbColor 不傳值（讓 iOS 跑原生 UISwitch、含 iOS 26 Liquid Glass 材質），ios_backgroundColor 由 caller 動態接 theme.bg.surface_hover。active track 統一走 theme.primary.main。impl makeSwitchTrackColor(theme) 回傳 theme 動態色（單參數，不再帶 variant）。"
    >
